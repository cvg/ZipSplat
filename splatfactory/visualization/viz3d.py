...
2) Add 3D points, camera frustums, or both
...
def plot_cameras(
    ...
    """Plot camera frustums from splatfactory Pose / Camera objects."""
    for i, (w_t_ci, cami) in enumerate(zip(poses, cameras)):
...
def show_figure(fig: go.Figure, port: int = 8890, host: str = "127.0.0.1"):
    from dash import Dash, dcc, html

    app = Dash(__name__)
    app.layout = html.Div([dcc.Graph(figure=fig, style={"height": "100vh"})])
